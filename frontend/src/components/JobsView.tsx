...
import { Briefcase, Users, ArrowRight, Play, FileText, Clock, Share2, Sparkles, Plus } from 'lucide-react';
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl sm:rounded-3xl p-4 sm:p-6 space-y-4 shadow-2xl">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-800 pb-3 sm:pb-4">
            ...
            <button
              ...
              className="px-3 py-1.5 bg-slate-800 hover:bg-slate-700 text-cyan-300 border border-slate-700 rounded-xl text-xs font-semibold flex items-center gap-1.5 transition-all self-start sm:self-auto"
            >
              <Share2 className="w-3.5 h-3.5" /> Xuất tin tuyển dụng JD này
            </button>
          </div>
