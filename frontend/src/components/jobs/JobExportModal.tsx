      ...
      <div className="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-2xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden">
        ...
        <div className="p-4 sm:p-5 border-b border-slate-800 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-gradient-to-tr from-cyan-600 to-blue-500 flex items-center justify-center text-white shadow-md shrink-0">
              <Share2 className="w-4 h-4 sm:w-5 sm:h-5" />
            </div>
            <div>
              <h3 className="font-bold text-white text-sm sm:text-base">Xuất tin Tuyển dụng Đa nền tảng</h3>
              <p className="text-[11px] sm:text-xs text-slate-400">Đăng tải lên TopCV, LinkedIn hoặc Facebook chỉ với 1 click</p>
            </div>
          </div>
        ...
        <div className="p-3 sm:p-4 bg-slate-950/60 border-b border-slate-800 flex items-center gap-2 sm:gap-3 overflow-x-auto no-scrollbar">
          <button
